...
function ModuleForms({ moduleKey }: { moduleKey: VenueOsModuleKey }) {
  switch (moduleKey) {
    ...
    case "tables":
      return (
        <div className="grid gap-4 xl:grid-cols-2">
          <form action={createVenueTableAction}><FormShell title="Create table catalog"><Input name="tableCode" placeholder="T12" /><Input name="name" placeholder="Main Stage 12" /><Input name="sectionName" placeholder="Main stage" /><Input name="floorObjectId" type="number" placeholder="Floor object ID" /><div className="grid gap-3 sm:grid-cols-2"><Input name="minimumGuests" type="number" placeholder="Min guests" /><Input name="maximumGuests" type="number" placeholder="Max guests" /><Input name="minimumSpendCents" type="number" placeholder="Minimum spend cents" /><Input name="depositPercent" type="number" placeholder="Deposit percent" /><Input name="reservationFeeCents" type="number" placeholder="Reservation fee cents" /><Input name="bottleMinimumCents" type="number" placeholder="Bottle minimum cents" /><Input name="serverSection" placeholder="Assigned server section" /><Input name="status" placeholder="available / reserved / blocked" /></div><Textarea name="enabledExperiences" rows={3} placeholder="One experience id per line: table_only, bottle_service, cabana" /><Textarea name="notes" rows={3} placeholder="Operational notes" /><SubmitButton label="Create table" /></FormShell></form>
          <form action={createVenueFloorPlanAction}><FormShell title="Create floor plan"><Input name="name" placeholder="Main room plan" /><Input name="width" type="number" placeholder="Width" /><Input name="height" type="number" placeholder="Height" /><Input name="backgroundImageUrl" placeholder="Background image URL" /><Input name="floorOrder" type="number" placeholder="Floor order" /><Input name="rotationDegrees" type="number" placeholder="Default rotation" /><Textarea name="notes" rows={3} placeholder="Floor notes" /><SubmitButton label="Create floor plan" /></FormShell></form>
          <form action={createVenueFloorObjectAction}><FormShell title="Add floor object"><Input name="floorPlanId" type="number" placeholder="Floor plan ID" /><Input name="objectType" placeholder="table / booth / cabana / lounge" /><Input name="label" placeholder="Object label" /><Input name="sectionName" placeholder="Section" /><Input name="capacity" type="number" placeholder="Capacity" /><div className="grid gap-3 sm:grid-cols-2"><Input name="x" type="number" placeholder="X" /><Input name="y" type="number" placeholder="Y" /><Input name="width" type="number" placeholder="Width" /><Input name="height" type="number" placeholder="Height" /><Input name="rotationDegrees" type="number" placeholder="Rotation" /><Input name="shape" placeholder="rect / circle / polygon" /><Input name="status" placeholder="available / pending / blocked" /></div><Textarea name="polygonPoints" rows={3} placeholder="Polygon points, one x,y pair per line" /><Textarea name="experienceDefinitions" rows={3} placeholder="id|Label|Description|true" /><Textarea name="notes" rows={3} placeholder="Floor object notes" /><SubmitButton label="Add object" /></FormShell></form>
        </div>
      );
    case "vip":
      return (
        <div className="grid gap-4 xl:grid-cols-2">
          <form action={createVenueServerAction}><FormShell title="Create server profile"><Input name="displayName" placeholder="Server name" /><Input name="staffProfileId" type="number" placeholder="Staff profile ID" /><Input name="email" placeholder="Email" /><Input name="phone" placeholder="Phone" /><Input name="photoUrl" placeholder="Photo URL" /><Input name="nickname" placeholder="Nickname" /><div className="grid gap-3 sm:grid-cols-2"><Input name="yearsEmployed" type="number" placeholder="Years employed" /><Input name="rating" type="number" placeholder="Rating" /><Input name="sectionAssignment" placeholder="Section assignment" /><Input name="availability" placeholder="available / off tonight" /><Input name="maxTables" type="number" placeholder="Max tables" /><Input name="maxGuests" type="number" placeholder="Max guests" /><Input name="priority" type="number" placeholder="Priority" /><Input name="imageMode" placeholder="show_image / generic_avatar / hide_image / disabled" /></div><Textarea name="languages" rows={3} placeholder="Languages, one per line" /><Textarea name="bio" rows={3} placeholder="Short bio" /><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="isLead" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Lead server</label><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="manualOnly" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Manual assignment only</label><Textarea name="notes" rows={3} placeholder="Server notes" /><SubmitButton label="Create server" /></FormShell></form>
          <form action={createVenueAddonAction}><FormShell title="Create VIP add-on"><Input name="name" placeholder="Birthday sparkler" /><Input name="category" placeholder="experience / hospitality" /><Input name="unitPriceCents" type="number" placeholder="Unit price cents" /><Input name="imageUrl" placeholder="Image URL" /><div className="grid gap-3 sm:grid-cols-2"><Input name="inventory" type="number" placeholder="Inventory" /><Input name="quantityLimit" type="number" placeholder="Quantity limit" /></div><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="isPerGuest" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Per guest pricing</label><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="featured" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Featured</label><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="recommended" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Recommended</label><Textarea name="description" rows={3} placeholder="Description" /><Textarea name="notes" rows={3} placeholder="Add-on notes" /><SubmitButton label="Create add-on" /></FormShell></form>
          ...
          <form action={createVenueBottlePackageAction}><FormShell title="Create bottle package"><Input name="name" placeholder="Champagne starter" /><Input name="category" placeholder="Champagne / Liquor / Wine / Beer / Custom" /><Input name="priceCents" type="number" placeholder="Price cents" /><Input name="imageUrl" placeholder="Image URL" /><div className="grid gap-3 sm:grid-cols-2"><Input name="inventory" type="number" placeholder="Inventory" /><Input name="quantityLimit" type="number" placeholder="Quantity limit" /></div><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="featured" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Featured</label><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="recommended" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Recommended</label><Textarea name="description" rows={3} placeholder="Description" /><Textarea name="packageItems" rows={3} placeholder="Package items, one per line" /><Textarea name="inventoryBindings" rows={3} placeholder="inventoryItemId|quantityPerPackage" /><Textarea name="mixers" rows={3} placeholder="Mixers, one per line" /><Textarea name="addOns" rows={3} placeholder="Add-ons, one per line" /><SubmitButton label="Create package" /></FormShell></form>
    ...
    case "inventory":
      return (
        <div className="grid gap-4 xl:grid-cols-2">
          ...
          <form action={createVenueInventoryItemAction}><FormShell title="Add inventory item"><Input name="name" placeholder="Item name" /><Input name="sku" placeholder="SKU" /><Input name="category" placeholder="Category" /><Input name="unitLabel" placeholder="Unit" /><Input name="onHandQuantity" type="number" placeholder="On hand" /><Input name="reorderThreshold" type="number" placeholder="Reorder threshold" /><Input name="parQuantity" type="number" placeholder="Par quantity" /><Input name="autoRestockQuantity" type="number" placeholder="Auto restock quantity" /><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="hidden" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Hidden</label><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="outOfStock" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Mark out of stock</label><label className="flex items-center gap-3 text-sm text-zinc-200"><input name="autoRestockEnabled" type="checkbox" className="h-4 w-4 accent-cyan-500" /> Enable auto restock</label><Textarea name="notes" rows={3} placeholder="Inventory notes" /><SubmitButton label="Create item" /></FormShell></form>

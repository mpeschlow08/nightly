...
import { NIGHTLY_FALLBACK_EVENT_IMAGE_URL } from "@/components/media/nightly-image-config";
...
export default function EventImage({ src, alt, orientation, className, priority }: Props) {
  return (
    <NightlyImage
      src={src}
      fallbackSrc={NIGHTLY_FALLBACK_EVENT_IMAGE_URL}
      alt={alt}

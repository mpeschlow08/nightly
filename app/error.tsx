  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.14),_transparent_42%),radial-gradient(circle_at_82%_14%,_rgba(167,139,250,0.12),_transparent_30%),linear-gradient(140deg,_#04070b_0%,_#090d18_55%,_#0d1322_100%)] px-4 py-10 text-zinc-100 sm:px-6 lg:px-8">
      <section className="mx-auto flex w-full max-w-4xl flex-col items-center rounded-[2rem] border border-white/10 bg-zinc-950/70 p-8 text-center shadow-[0_25px_90px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-12">
        ...
        <p className="mt-8 inline-flex items-center rounded-full border border-rose-300/30 bg-rose-400/10 px-3 py-1 text-xs uppercase tracking-[0.28em] text-rose-100">
          Something Went Wrong
        </p>

        <h1 className="mt-5 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
          Nightly hit a temporary glitch.
        </h1>

        <p className="mt-4 max-w-2xl text-sm leading-7 text-zinc-300 sm:text-base">
          No worries, your session is still safe. You can retry this screen, go back, or jump to Home and keep moving.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <button
            type="button"
            onClick={reset}
            className="inline-flex items-center rounded-full border border-rose-300/40 bg-rose-500/10 px-5 py-2.5 text-sm font-medium text-rose-100 transition hover:border-rose-300/60"
          >
            Try Again
          </button>

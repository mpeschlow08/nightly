      ...
      <div className="mx-auto max-w-7xl space-y-6 px-4 pb-24 pt-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-4">
            <div className="h-52 animate-pulse rounded-[1.2rem] border border-white/10 bg-white/5" />
          ...
          <div className="space-y-4">
            {Array.from({ length: 5 }).map((_, index) => (
              <div key={index} className="h-36 animate-pulse rounded-[1.2rem] border border-white/10 bg-white/5" />
            ))}
          </div>
        </div>
      </div>

      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-4 pb-24 pt-3 sm:px-5 lg:px-6">
          ...
          {specialGuests.length > 0 ? (
            <section className="mt-5 rounded-[1.2rem] border border-amber-300/25 bg-amber-500/10 p-4 shadow-[0_18px_48px_rgba(0,0,0,0.35)]">
              <VenueSectionHeading title="Special Guests" />
              <div className="mt-2 grid gap-2 sm:grid-cols-2">
                {specialGuests.map((guest) => (
                  <article key={guest.id} className="rounded-[0.9rem] border border-white/10 bg-black/25 p-3">

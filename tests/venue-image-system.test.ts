  ...
  const ranked = rankGooglePhotoCandidates(
    {
      ...
      photos: [
        { reference: "a", resourceName: "places/abc/photos/a", widthPx: 400, heightPx: 400, attributions: [] },
        { reference: "b", resourceName: "places/abc/photos/b", widthPx: 1600, heightPx: 900, attributions: [] },
      ],
      attributions: [],
      photoReferences: ["a", "b"],
